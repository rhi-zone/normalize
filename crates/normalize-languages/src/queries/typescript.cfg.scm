; TypeScript CFG query
; Captures control flow nodes for CFG construction.
; See normalize-cfg for the full capture vocabulary.
; Verified against arborium-typescript node-types.json.
; TypeScript uses the same grammar as JavaScript with type extensions —
; node types for control flow are identical.
