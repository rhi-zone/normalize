...
; Verified against arborium-javascript node-types.json.
; Node types are identical to TypeScript — shared grammar base.
...
; JS catch clauses are untyped — no cfg.try.catch.type capture here.
