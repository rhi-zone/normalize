...
- `fixtures/` — small representative source files (30-60 lines each) used by `query_fixtures.rs`, one per language: Rust, Python, Go, TypeScript, Java, Ruby, Kotlin, Swift, Scala, PHP, Dart, Elixir, C, C++, C#, Haskell, OCaml, Erlang, Lua, Groovy, Julia, R, F#, Gleam, Clojure, Scheme, D, Visual Basic .NET, Objective-C, Idris, Lean 4, ReScript, Elm.
