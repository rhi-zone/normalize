...
- `fixtures/` — small representative source files (30-60 lines each) used by `query_fixtures.rs`, one per language: Rust, Python, Go, TypeScript, Java, Ruby, Kotlin, Swift, Scala, PHP, Dart, Elixir, C, C++, C#.
