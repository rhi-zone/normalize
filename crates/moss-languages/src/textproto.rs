...
impl Language for TextProto {
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["textproto", "pbtxt"].contains(&ext) {
            return None;
        }
    ...
    fn module_name_to_paths(&self, module: &str) -> Vec<String> {
        vec![format!("{}.textproto", module), format!("{}.pbtxt", module)]
    }
    ...
    fn should_skip_package_entry(&self, name: &str, is_dir: bool) -> bool {
        ...
        !is_dir && !has_extension(name, &["textproto", "pbtxt"])
    }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name
            .strip_suffix(".textproto")
            .or_else(|| entry_name.strip_suffix(".pbtxt"))
