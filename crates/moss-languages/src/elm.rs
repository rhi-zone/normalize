...
impl Language for Elm {
    fn name(&self) -> &'static str { "Elm" }
    fn extensions(&self) -> &'static [&'static str] { &["elm"] }
    fn grammar_name(&self) -> &'static str { "elm" }

    fn has_symbols(&self) -> bool { true }

    fn container_kinds(&self) -> &'static [&'static str] {
        &["module_declaration", "type_alias_declaration", "type_declaration"]
    }
    ...
    fn public_symbol_kinds(&self) -> &'static [&'static str] {
        &["value_declaration", "type_alias_declaration", "type_declaration"]
    }
    ...
    fn lang_key(&self) -> &'static str { "elm" }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".elm").unwrap_or(entry_name).to_string()
    }
