...
impl Language for Zig {
    ...
    fn extensions(&self) -> &'static [&'static str] { &["zig"] }
    fn grammar_name(&self) -> &'static str { "zig" }
    ...
    fn lang_key(&self) -> &'static str { "zig" }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".zig").unwrap_or(entry_name).to_string()
    }
