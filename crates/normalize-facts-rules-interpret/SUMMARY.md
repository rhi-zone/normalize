...
Interpreted Datalog rule evaluation for normalize code facts — runs `.dl` rule files directly without compilation using `ascent-interpreter` (v0.1.3).
