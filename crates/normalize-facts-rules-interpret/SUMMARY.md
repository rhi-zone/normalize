...
Built-in Datalog rules in `src/builtin_dl/` (22 files): architectural patterns including `barrel_file`, `bidirectional_deps`, `circular_deps`, `dead_api`, `deep_nesting`, `duplicate_symbol`, `effects`, `exception_flow`, `fan_out`, `god_class`, `god_file`, `hub_file`, `layering_violation`, `liveness`, `missing_export`, `missing_impl`, `missing_test`, `orphan_file`, `resolution`, `self_import`, `stale_mock`, `unused_import`.
