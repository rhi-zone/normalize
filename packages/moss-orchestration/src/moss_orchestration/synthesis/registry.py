...
class SynthesisRegistry:
    ...
    def register_builtins(self) -> None:
        ...
        try:
            from moss_orchestration.synthesis.generators import PlaceholderGenerator
        ...
        try:
            from moss_orchestration.synthesis.generators import TemplateGenerator
        ...
        try:
            from moss_orchestration.synthesis.generators import LLMGenerator, MockLLMProvider
        ...
        try:
            from moss_orchestration.synthesis.generators import ComponentGenerator
        ...
        try:
            from moss_orchestration.synthesis.generators import SMTGenerator
        ...
        try:
            from moss_orchestration.synthesis.generators import PBEGenerator
        ...
        try:
            from moss_orchestration.synthesis.generators import SketchGenerator
        ...
        try:
            from moss_orchestration.synthesis.validators import PytestValidator
        ...
        try:
            from moss_orchestration.synthesis.libraries import MemoryLibrary
        ...
        try:
            from moss_orchestration.synthesis.libraries import LearnedLibrary
