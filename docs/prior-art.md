...
But also: human code is equally imperfect. Good reviewers catch each other's mistakes - except when they don't. No process catches everything. The question isn't "is AI-generated code perfect" but "is it better or worse than the alternative at the same scale." That's an empirical question without a clear answer yet.
