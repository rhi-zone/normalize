...
See `CHANGELOG.md` for completed features (Phases 15-21, 23-28).
...
- [x] Extract `moss.api` as the canonical typed API surface (MossAPI class)
- [x] Full type hints + docstrings for introspection
...
- [x] `moss health` - Comprehensive project health (Phase 28)
  - Health score with letter grade
  - Dependency, structural, test, and API surface analysis
  - Concise `moss health` + verbose `moss report`
